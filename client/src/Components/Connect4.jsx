    ...
    useEffect(() => {
        socket.on("receive_msg", (player_data) => {
            ...
            if (lock[player_data[0].row][player_data[0].col] && player_data[1] === it % 2) {
                ...
                // console.log("inside");
                if (it % 2 === 0) {
                    refs.current[player_data[0].col * 7 + player_data[0].row].innerHTML = `<img src='${redBall}'>`
                    data[player_data[0].row][player_data[0].col] = 1;


                }
                else {
                    refs.current[player_data[0].col * 7 + player_data[0].row].innerHTML = `<img src='${purpleBall}'>`;
